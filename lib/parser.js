...

{
    ...
    internals.specials =  function (code) {
...

{
    ...
    internals.c0Controls = function (code) {
...

{
    ...
    internals.c1Controls = function (code) {

        return lookup[code];
    };
}

internals.isSurrogate = function (code) {
...
class Parser {
     ...
     */
    parseQuotedPair({ allowMalformedUnicode = false } = {}) {
