...
const PunyLength = require('./punylength');
// Declare internals
...
exports.validate = internals.validate = function (email, options, callback) {
            ...
            case internals.components.domain:
                ...
                switch (token) {
                    ...
                    case '.':
                        ...
                        else if (PunyLength(atomData.domains[elementCount]) > 63) {
    ...
    if (maxResult < internals.categories.rfc5322) {
        ...
        if (context.now === internals.components.contextQuotedString) {
            ...
            // Other errors
        else if (PunyLength(parseData.domain) > 255) {
            // http://tools.ietf.org/html/rfc5321#section-4.5.3.1.2
            //   The maximum total length of a domain name or number is 255 octets.
            updateResult(internals.diagnoses.rfc5322DomainTooLong);
        }
        else if (Buffer.byteLength(parseData.local, 'utf8') + PunyLength(parseData.domain) + /* '@' */ 1 > 254) {
            // http://tools.ietf.org/html/rfc5321#section-4.1.2
            //   Forward-path   = Path
            //
            //   Path           = "<" [ A-d-l ":" ] Mailbox ">"
